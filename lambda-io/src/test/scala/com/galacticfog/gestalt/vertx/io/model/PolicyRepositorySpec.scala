...
class PolicyRepositorySpec extends Specification {
  ...
  "PolicyRepository" should {
    ...
    "create new record" in new AutoRollback {
      val created = PolicyRepository.create(id = "MyString", handlerId = "MyString", policyName = "MyString", artifactName = "MyString", eventFilter = "MyString", policyTypeId = 1L, timeOut = 1L)
